...
export const register = (data: { username: string; email: string; password: string; captcha?: string; captcha_key?: string; referrer?: string }) =>
...
/** 发送找回密码验证码 */
export const sendResetCode = (data: { email: string; captcha?: string; captcha_key?: string }) =>
